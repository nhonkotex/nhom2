...
PagesDao dl1 = new PagesDao(DbCon.getConnetion());
List<Pages> quanly1 = dl1.getAllCT(); 
                             ...
                             <div class="blog__sidebar__recent">
                                <%
									if(!quanly.isEmpty()) {
										for (Pages q : quanly1) {		
										%>
                                <a href="pages.jsp" class="blog__sidebar__recent__item">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="blog__item">
                                ...
                                <div class="blog__item__text">
                                    ...
                                    <p><%=q.getMessage() %> </p>
                                    <a href="#" class="blog__btn">Trả lời<span class="arrow_right"></span></a>
                                </div>
                                                                               <%}	
										}
										%>
