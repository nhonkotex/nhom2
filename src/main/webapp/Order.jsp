...
<%@page import="baoveCSDL.dao.ProductDao"%>
<%@page import="baoveCSDL.dao.OrderDao"%>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="checkout__order">
                                ...
                                <ul>
                                    <li><%= c.getName() %><span><%=c.getPrice() %>00 VNĐ</span></li>
                                
                                </ul>
                                 	<%}
									}
									%>
                                <div class="checkout__order__subtotal">Subtotal <span>${(total>0)?dcf.format(total):0}00 VNĐ</span></div>
                                <div class="checkout__order__total">Total <span>${(total>0)?dcf.format(total):0}00 VNĐ</span></div>
                                <div class="checkout__input__checkbox">
                                    <label for="acc-or">
                                        Create an account?
