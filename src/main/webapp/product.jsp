...
<%@page import="baoveCSDL.dao.addProductDao"%>
...
// Tạo đối tượng addProductDao
addProductDao productDao = new addProductDao(DbCon.getConnetion());

// Gọi phương thức getCountProducts() để lấy tổng số sản phẩm
int totalCount = productDao.getCountProducts();
...
<body>
                                ...
                                <div class="col-lg-4">
                                    ...
                                    <div class="product__discount__item">
                                        ...
                                        <div class="product__discount__item__pic set-bg"
                                            ...
                                            data-setbg="img/sp/<%=q.getImage() %>">
                                            <div class="product__discount__percent"><%=q.getSale() %>%</div>
                                            <ul class="product__item__pic__hover">
                                                <li><a href="#"><i class="fa fa-heart"></i></a></li>
                                                <li><a href="#"><i class="fa fa-retweet"></i></a></li>
                                        ...
                                        <div class="product__discount__item__text">
                                            ...
                                            <h5><a href="#"><%=q.getName() %></a></h5>
                                            <div class="product__item__price"> <span><%=q.getPrice() %>00 </span>  <%=q.getDiscountedPriceR() %>00 VNĐ</div>
                                        </div>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6">
                    <div class="footer__about">
                        <div class="footer__about__logo">
                            <a href="./index.html"><img src="img/logotao.jpeg" alt=""></a>
                        </div>
                        <ul>
  ...
  function fillSearch(value) {
    document.getElementsByName("searchString")[0].value = value;
  }
</script>
